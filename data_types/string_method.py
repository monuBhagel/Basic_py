...
# List of string methods and their descriptions
string_methods = [
...
md_content = "# Python String Methods\n\n"
md_content += "| Method | Description |\n"
md_content += "|--------|-------------|\n"

for method, description in string_methods:
    md_content += f"| {method} | {description} |\n"

# Write the content to a markdown file
with open("data_types/string_method.md", "w") as file:
    file.write(md_content)

print("Markdown file 'string_method.md' has been created.")
